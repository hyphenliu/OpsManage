...
urlpatterns = [
    ...
    # hyphen add 20180714
    url(r'type/$', assets_api.type_list),
    url(r'type/(?P<id>[0-9]+)/$', assets_api.type_detail),
    url(r'contract/$', assets_api.contract_list),
    url(r'contract/(?P<id>[0-9]+)/$', assets_api.contract_detail),
    url(r'maintenance/$', assets_api.maintenance_list),
    url(r'maintenance/(?P<id>[0-9]+)/$', assets_api.maintenance_detail),
    url(r'provider/$', assets_api.provider_list),
    url(r'provider/(?P<id>[0-9]+)/$', assets_api.provider_detail),
    url(r'status/$', assets_api.status_list),
    url(r'status/(?P<id>[0-9]+)/$', assets_api.status_detail),
    url(r'level/$', assets_api.level_list),
    url(r'level/(?P<id>[0-9]+)/$', assets_api.level_detail),
    url(r'monitor/$', assets_api.monitor_list),
    url(r'monitor/(?P<id>[0-9]+)/$', assets_api.monitor_detail),
